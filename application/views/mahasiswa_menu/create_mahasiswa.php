                                    ...
                                    <div class="card-body">
                                        <form action="<?= site_url('user_menu/insert')?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Tanggal Mulai Magang" name="start-date">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-control-label" for="exampleFormControlInput1">Tanggal Selesai Magang <span class="text-danger">*</span></label>
                                                <input type="date" class="form-control" placeholder="Tanggal Selesai Magang" name="end-date">
                                            </div>
                                            <div class="form-group">
