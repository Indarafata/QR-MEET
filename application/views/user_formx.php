          ...
          <div class="header-body">
            <div class="row align-items-center py-4">
              <div class="col-lg-6 col-7">
                <h6 class="h2 text-white d-inline-block mb-0">Form Absensi</h6>
              </div>
            </div>
          </div>
        </div>
                    ...
                    <div class="card-wrapper">
                        ...
                        <!-- Card header -->
                            <div class="card-header">
                                <h3 class="mb-0">Form Absensi - Input Email</h3>
                            </div>
                            <!-- Card body -->
                              <div class="card-body">
                                <?php
                                  ...
                                  <form action="<?php echo $base_url;?>index.php/user/savex" method="post">
                                      ...
                                      <input type="hidden" class="form-control" name="txt_id" value="<?php echo $id;?>" id="txt_id" class="form-control col-md-7 col-xs-12">
